...
export default {
  ...
  properties: {
    ...
    external_command: {
      ...
      description: 'Optional external python3 file to execute and send the result, HTML or RTF, to. The default is nothing in which case the result will be copied to the clipboard.',
      type: 'string',
      default: '',
      order: 9,
    }
